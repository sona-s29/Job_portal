...
export const getAppliedJobs = async (req, res) =>{
    try {
       ...
       if(!application){
        return res.status(400).json({
            message:"There is no application",
            success:false
        })
       };
...
// admin will see how many users applied for the jobs
...
// checking the status of the applications of the user [rejected OR accepted]
